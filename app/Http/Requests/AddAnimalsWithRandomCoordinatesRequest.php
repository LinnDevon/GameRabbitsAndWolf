...
/**
 * Класс реквеста с валидацией для создания объектов на игровом поле с рандомными координатами.
 */
class AddAnimalsWithRandomCoordinatesRequest extends FormRequest
{
    /**
